...
public class AnswerQueriesActivity  extends AppCompatActivity {
    ...
    private AnsQueryAdapter registerTeamAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(AnswerQueriesActivity.this,TeacherDashboard.class);
        ...
        Toast.makeText(AnswerQueriesActivity.this,"PostQueries Opens! ",Toast.LENGTH_SHORT).show();
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                registerTeamAdapter = new AnsQueryAdapter(AnswerQueriesActivity.this, R.layout.item_queries, momclasses);
