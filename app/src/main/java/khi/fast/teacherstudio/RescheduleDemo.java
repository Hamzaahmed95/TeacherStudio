...
public class RescheduleDemo  extends AppCompatActivity {
    ...
    private RescheduleDemoAdapter RescheduleDemoAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(RescheduleDemo.this,StudentDashboard.class);
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                RescheduleDemoAdapter = new RescheduleDemoAdapter(RescheduleDemo.this, R.layout.item_reschedule_demo, momclasses);
                System.out.println("here => "+RescheduleDemoAdapter);
                if(mmessageListViewMOM!=null)
                    mmessageListViewMOM.setAdapter(RescheduleDemoAdapter);
            ...
            mChildEventListener = new ChildEventListener() {
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    if(momclass!=null)
                        ...
                        RescheduleDemoAdapter.add(momclass);
