...
public class UploadDemoAdapter extends ArrayAdapter<DemoSlotsClass>{
    ...
    public UploadDemoAdapter(Context context, int resource, List<DemoSlotsClass> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = ((Activity) getContext()).getLayoutInflater().inflate(R.layout.item_upload_demo, parent, false);
        }
        ...
        final Button showResponse=(Button)convertView.findViewById(R.id.showResponse);
        ...
        showResponse.setOnClickListener(new View.OnClickListener() {
            @Override
